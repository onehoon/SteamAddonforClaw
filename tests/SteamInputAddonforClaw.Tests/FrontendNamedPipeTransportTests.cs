...
public sealed class FrontendNamedPipeTransportTests
{
    ...
    [Theory]
    [InlineData("{\"ProtocolVersion\":9,\"Kind\":\"Request\",\"RequestId\":1}")]
    [InlineData("{\"ProtocolVersion\":9,\"Kind\":\"Request\",\"RequestId\":1,\"Method\":null}")]
    [InlineData("{\"ProtocolVersion\":9,\"Kind\":\"Request\",\"RequestId\":1,\"Method\":123}")]
