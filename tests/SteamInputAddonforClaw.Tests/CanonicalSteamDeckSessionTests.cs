...
public sealed class CanonicalSteamDeckSessionTests
{
    ...
    private sealed class FakeNative : ICanonicalViiperNativeApi
    {
        ...
        public USBDeviceAttachResult AttachUSBDeviceEx(nuint handle) { Calls.Add("AttachUSBDeviceEx"); return USBDeviceAttachResult.Success; }
        ...
        public bool GetUSBDeviceAttachmentState(nuint handle, out USBDeviceAttachmentState state) { Calls.Add("GetUSBDeviceAttachmentState"); state = AttachmentState; return true; }
