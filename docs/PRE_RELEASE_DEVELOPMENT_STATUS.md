...
> This document preserves the development-oriented repository README that was used
> before the public user-facing README was introduced on 2026-08-23.
>
> It is kept as a historical development snapshot. For current supported devices,
> features, usage, and release information, see the repository root
> [`README.md`](../README.md).
