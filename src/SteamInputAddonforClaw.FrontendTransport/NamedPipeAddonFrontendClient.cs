...
public sealed class NamedPipeAddonFrontendClient : IAddonFrontendControl, IAsyncDisposable
{
    ...
    public Task<FrontendEnterBiosResult> RequestEnterBiosAsync(CancellationToken t = default) => SendAsync<FrontendEnterBiosResult>(FrontendRpcMethod.RequestEnterBios, null, t);
