...
public sealed class NamedPipeAddonFrontendClient : IAddonFrontendControl, IAsyncDisposable
{
    ...
    public Task<FrontendCenterMStartupMutationResult> SetCenterMStartupEnabledAsync(bool enabled, CancellationToken t = default) => SendAsync<FrontendCenterMStartupMutationResult>(FrontendRpcMethod.SetCenterMStartupEnabled, FrontendWireCodec.Payload(new SetCenterMStartupEnabledRequest(enabled)), t);
