...
public sealed class NamedPipeAddonFrontendClient : IAddonFrontendControl, IAsyncDisposable
{
    ...
    public Task<FrontendSteamFseSnapshot> CaptureSteamFseAsync(CancellationToken t = default) => SendAsync<FrontendSteamFseSnapshot>(FrontendRpcMethod.CaptureSteamFse, null, t);
    public Task<FrontendSteamFseMutationResult> SetSteamFseEnabledAsync(bool enabled, CancellationToken t = default) => SendAsync<FrontendSteamFseMutationResult>(FrontendRpcMethod.SetSteamFseEnabled, FrontendWireCodec.Payload(new SetSteamFseEnabledRequest(enabled)), t);
    public Task<FrontendClawHudSnapshot> CaptureClawHudAsync(CancellationToken t = default) => SendAsync<FrontendClawHudSnapshot>(FrontendRpcMethod.CaptureClawHud, null, t);
    public Task<FrontendClawHudSnapshot> SetClawHudEnabledAsync(bool enabled, CancellationToken t = default) => SendAsync<FrontendClawHudSnapshot>(FrontendRpcMethod.SetClawHudEnabled, FrontendWireCodec.Payload(new SetClawHudEnabledRequest(enabled)), t);
    public Task<FrontendClawHudMutationResult> MutateClawHudSettingAsync(FrontendClawHudMutationIntent intent, CancellationToken t = default) => SendAsync<FrontendClawHudMutationResult>(FrontendRpcMethod.MutateClawHudSetting, FrontendWireCodec.Payload(intent), t);
    public Task<FrontendShortcutEditorSnapshot> CaptureShortcutEditorAsync(CancellationToken t = default) => SendAsync<FrontendShortcutEditorSnapshot>(FrontendRpcMethod.CaptureShortcutEditor, null, t);
    public Task<FrontendShortcutMutationResult> MutateShortcutAsync(FrontendShortcutMutationIntent intent, CancellationToken t = default) => SendAsync<FrontendShortcutMutationResult>(FrontendRpcMethod.MutateShortcut, FrontendWireCodec.Payload(intent), t);
    public Task<FrontendScreenshotFolderMutationResult> SetScreenshotSaveFolderAsync(string? folder, CancellationToken t = default) => SendAsync<FrontendScreenshotFolderMutationResult>(FrontendRpcMethod.SetScreenshotSaveFolder, FrontendWireCodec.Payload(new SetScreenshotSaveFolderRequest(folder)), t);
    public Task<FrontendSettingsSnapshot> SetFrontButtonMappingAsync(SteamInputAddonforClaw.Contracts.FrontButtons.FrontButtonMappingSettings mapping, CancellationToken t = default) => SendAsync<FrontendSettingsSnapshot>(FrontendRpcMethod.SetFrontButtonMapping, FrontendWireCodec.Payload(new SetFrontButtonMappingRequest(mapping)), t);
    public Task<FrontendSettingsSnapshot> SetBackButtonMappingAsync(SteamInputAddonforClaw.Contracts.BackButtons.BackButtonMappingSettings mapping, CancellationToken t = default) => SendAsync<FrontendSettingsSnapshot>(FrontendRpcMethod.SetBackButtonMapping, FrontendWireCodec.Payload(new SetBackButtonMappingRequest(mapping)), t);
    ...
    public Task<AddonQuickSettingsShellSnapshot> CaptureAddonQuickSettingsShellAsync(CancellationToken t = default) => SendAsync<AddonQuickSettingsShellSnapshot>(FrontendRpcMethod.CaptureAddonQuickSettingsShell, null, t);
    public Task<AddonQuickSettingsTabOrderSnapshot> CaptureAddonQuickSettingsTabOrderAsync(CancellationToken t = default) => SendAsync<AddonQuickSettingsTabOrderSnapshot>(FrontendRpcMethod.CaptureAddonQuickSettingsTabOrder, null, t);
    public Task<AddonQuickSettingsTabOrderMutationResult> MoveAddonQuickSettingsTabAsync(AddonQuickSettingsTabOrderMoveIntent intent, CancellationToken t = default) => SendAsync<AddonQuickSettingsTabOrderMutationResult>(FrontendRpcMethod.MoveAddonQuickSettingsTab, FrontendWireCodec.Payload(intent), t);
    public Task<QuickSettingsMutationResult> MutateQuickSettingAsync(QuickSettingsMutationIntent intent, CancellationToken t = default) => SendAsync<QuickSettingsMutationResult>(FrontendRpcMethod.MutateQuickSetting, FrontendWireCodec.Payload(intent), t);
    ...
    public Task<FrontendClawSensorProbeSnapshot> StartClawSensorProbeAsync(FrontendClawSensorProbeMode mode, CancellationToken t = default) => SendAsync<FrontendClawSensorProbeSnapshot>(FrontendRpcMethod.StartClawSensorProbe, FrontendWireCodec.Payload(new StartClawSensorProbeRequest(mode)), t);
    ...
    public Task<FrontendBatteryChargeLimitTestSnapshot> CaptureBatteryChargeLimitTestAsync(CancellationToken t = default) => SendAsync<FrontendBatteryChargeLimitTestSnapshot>(FrontendRpcMethod.CaptureBatteryChargeLimitTest, null, t);
    public Task<FrontendBatteryChargeLimitTestMutationResult> SetBatteryChargeLimitTestEnabledAsync(bool enabled, CancellationToken t = default) => SendAsync<FrontendBatteryChargeLimitTestMutationResult>(FrontendRpcMethod.SetBatteryChargeLimitTestEnabled, FrontendWireCodec.Payload(new SetBatteryChargeLimitTestEnabledRequest(enabled)), t);
    public Task<FrontendBatteryChargeLimitTestMutationResult> SetBatteryChargeLimitTestPercentAsync(int percent, CancellationToken t = default) => SendAsync<FrontendBatteryChargeLimitTestMutationResult>(FrontendRpcMethod.SetBatteryChargeLimitTestPercent, FrontendWireCodec.Payload(new SetBatteryChargeLimitTestPercentRequest(percent)), t);
    public Task<FrontendXbox360RumbleLoopSnapshot> CaptureXbox360RumbleLoopDiagnosticAsync(CancellationToken t = default) => SendAsync<FrontendXbox360RumbleLoopSnapshot>(FrontendRpcMethod.CaptureXbox360RumbleLoopDiagnostic, null, t);
    public Task<FrontendXbox360RumbleLoopSnapshot> StartXbox360RumbleLoopDiagnosticAsync(CancellationToken t = default) => SendAsync<FrontendXbox360RumbleLoopSnapshot>(FrontendRpcMethod.StartXbox360RumbleLoopDiagnostic, null, t);
    public Task<FrontendXbox360RumbleLoopSnapshot> StopXbox360RumbleLoopDiagnosticAsync(CancellationToken t = default) => SendAsync<FrontendXbox360RumbleLoopSnapshot>(FrontendRpcMethod.StopXbox360RumbleLoopDiagnostic, null, t);
    public Task<FrontendBatteryChargeLimitSnapshot> CaptureBatteryChargeLimitAsync(CancellationToken t = default) => SendAsync<FrontendBatteryChargeLimitSnapshot>(FrontendRpcMethod.CaptureBatteryChargeLimit, null, t);
    public Task<FrontendBatteryChargeLimitMutationResult> SetDeviceBatteryChargeLimitEnabledAsync(bool enabled, CancellationToken t = default) => SendAsync<FrontendBatteryChargeLimitMutationResult>(FrontendRpcMethod.SetDeviceBatteryChargeLimitEnabled, FrontendWireCodec.Payload(new SetDeviceBatteryChargeLimitEnabledRequest(enabled)), t);
