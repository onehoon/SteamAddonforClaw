...
public sealed class NamedPipeAddonFrontendClient : IAddonFrontendControl, IAsyncDisposable
{
    ...
    public Task<FrontendGameProfileMutationResult> SetGameProfileCpuBoostAsync(uint appId, SteamInputAddonforClaw.Contracts.DeviceProfiles.CpuBoostMode ac, SteamInputAddonforClaw.Contracts.DeviceProfiles.CpuBoostMode dc, CancellationToken t = default) => SendAsync<FrontendGameProfileMutationResult>(FrontendRpcMethod.SetGameProfileCpuBoost, FrontendWireCodec.Payload(new SetGameProfileCpuBoostRequest(appId, ac, dc)), t);
