...
// firmware restart. A v35 peer must fail the handshake before the new operation is available.
public static class FrontendTransportProtocol { public const int CurrentVersion = 36; }
